...
// TODAY TAB
// ═══════════════════════════════════════════
var DEFAULT_BLOCK_ORDER = ['affirmation','calendar','why','intimacy','mood','fertility','symptoms','relief','tasks','note','ritual'];
...
function renderHabitCareBasics() {
  ...
  html += '</div>';
  html += '<div class="insight-mini-meta">These still feed your insights and energy budget, but live here with habits now.</div>';
  html += '</div></div>';
  return html;
}
...
function showMaximizeGuide() {
  ...
  [
    ['today tab','Your calm daily home base. Use it for affirmation, phase context, mood, fertility signs if enabled, symptoms, support ideas, tasks, notes, and the opening or closing ritual.'],
    ...
    ['habits tab','Track supportive routines, water, sleep, and cycle-aligned planning. Use Today, Plan, Month, and Year views to see consistency without perfection. Habit goals can be daily, weekdays, 3x/week, or luteal-only.'],
